...
CREATE TABLE IF NOT EXISTS `user_activity` (
  ...
  `category_two_id` int NOT NULL COMMENT '二级目录 ID',
  ...
  CONSTRAINT `FK_user_activity_category_two` FOREIGN KEY (`category_two_id`) REFERENCES `category_two` (`category_two_id`),
...
CREATE TABLE IF NOT EXISTS `user_similarity` (
  ...
  `user_ref_id` int NOT NULL COMMENT '关联用户 ID',
  ...
  CONSTRAINT `FK_user_similarity_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_user_similarity_user_2` FOREIGN KEY (`user_ref_id`) REFERENCES `user` (`id`)
